...
public class UserManagementSteps {
	...
	public void createViewOnlyProfileForSetupModule() {
		...
		clickWhenClickable(setupModuleCheckbox);
		clickWhenClickable(By.xpath("//label[normalize-space()='Setup Module']"));
		uncheckIfSelected(By.xpath("//label[@for='chkg01UserAdd']/preceding-sibling::input"));
		uncheckIfSelected(By.xpath("//label[@for='chkg01UserEdit']/preceding-sibling::input"));
		uncheckIfSelected(By.xpath("//label[@for='chkg01UserDelete']/preceding-sibling::input"));
		clickWhenClickable(By.id("btnSave"));
	}
	...
	public void verifyFullProfileAccess() {
		...
		clickWhenClickable(actionMenu);
		clickWhenClickable(By.xpath("//a[@id='btnDeleteProfile']//div[@class='gridRecordContextInner']")); // Delete
		sleep(1000);
		clickWhenClickable(By.xpath("//div[@id='profileModel']//button[@id='btnDeleteConfirm']")); // Delete
	...
	public void verifyNoAddEditDeletePermissionForProfiles() {
		...
		// Verify 'Add New Profile' button is not visible
	...
	public void uncheckIfSelected(By locator) {
