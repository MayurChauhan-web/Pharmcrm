...
public class SetupSteps {
	...
	public void loginAsAdminForSetupModule() {
	...
	@When("I create a new user with email for Setup Module {string}")
	public void createNewUserWithEmailForSetupModule(String email) {
	...
	public void loginUsingNewUserForSetupModule() {
		sleep(2000);
	...
	public void resetUserPasswordForSetupModule() {
		sleep(3000);
	...
	public void assignProfileAndWorkspaceToUserForSetupModule() {
		sleep(2000);
	...
	public void createProfileWithAddEditDeleteAndViewGrossMarginAccessForPatientMedication() {
		driver.get(baseUrl + "/Setup/Home/Profiles");
		sleep(1000);
		clickWhenClickable(By.xpath("//span[normalize-space()='New Profile']"));
		selectDropdownByIndexWhenReady(By.id("ddProfileType"), 1);
	...
	public void createProfileWithAddEditDeleteViewGrossMarginAndUpdateSyncAccessForPatientMedication() {
		driver.get(baseUrl + "/Setup/Home/Profiles");
		sleep(1000);
		clickWhenClickable(By.xpath("//span[normalize-space()='New Profile']"));
		selectDropdownByIndexWhenReady(By.id("ddProfileType"), 1);
	...
	public void createProfileWithAddAccessOnlyToCareGiverName() {
		...
		clickWhenClickable(By.xpath("//label[normalize-space()='Patient Module']"));
		sleep(3000);
		clickWhenClickable(By.xpath("//label[@for='chkg21PatientCareGiverNameEdit']"));
