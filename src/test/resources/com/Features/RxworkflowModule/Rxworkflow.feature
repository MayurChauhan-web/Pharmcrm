...
When I navigate to the Action Workflow page test
And I select No records using the check box Action workflow 
And I click on Callout to Selected Action Workflow 
Then I should see a validation message indicating no record selected please select one Action Workflow 
And the Callout action should not be performed Action Workflow 
...
When user click on the go button
When I navigate to the Action Workflow page test
And I click on Send VCard For Action Workflow test
Then I should see a validation message indicating no record is selected, please select one test
And the Send VCard action should not be performed test
...
And user enter the organization password
When user click on the go button
When I navigate to the Sync Workflow page test
And I click on Timeline Add Action test
Then I should see a validation message indicating no record is selected, please select one test
And the Timeline Add action should not be performed test
...
And user enter the organization password
When user click on the go button
When I navigate to the Followup Workflow page test
And I click on Add Template test
And I leave all required fields blank test
And I click Submit test
Then I should see validation messages for all required fields test
And the Followup Workflow template should not be created test
...
When user click on the go button
When I navigate to the Followup Workflow page test
And I click on Add Quick test
And I leave all required fields blank test
And I click Send for Followup Workflow Quick Notes test
Then I should see validation messages for all required fields test
And the followup workflow action should not be updated test

# Control Audit 
Scenario: Drug Dispense Credit Add Action Validation on Blank Submission in Control Audit Class1
Given user launch browser
Then user click on the user type dropdown
When user select the user type as organization from user type dropdown
Then user enter the organization emailid
And user enter the organization password
When user click on the go button
When I navigate to the Control Audit1 page test
And the user should be able to open Details View in Control Audit Class1
And I leave all required fields blank in Control Audit Class1
When I click on Drug Dispense Credit Add action in Control Audit Class1
Then I should see validation messages for all required fields test

Scenario: Drug Dispense Audit Add Action Validation on Blank Submission in Control Audit Class1
Given user launch browser
Then user click on the user type dropdown
When user select the user type as organization from user type dropdown
Then user enter the organization emailid
