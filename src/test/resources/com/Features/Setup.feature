Feature: Setup Module scenarios
  ...
  Given I log in as admin for Setup Module
  When I create a new user with email for Setup Module "testuser25_static@mailinator.com"
  ...
  Given I log in as admin for Setup Module
  When I create a new user with email for Setup Module "testuser17_static@mailinator.com"
  ...
  Given I log in as admin for Setup Module
  When I create a new user with email for Setup Module "testuser19_static@mailinator.com"
  ...
  Given I log in as admin for Setup Module
  When I create a new user with email for Setup Module "testuser30_static@mailinator.com"
  ...
  When I create a new user with email for Setup Module "testuser31_static@mailinator.com"
  ...
  Given I log in as admin for Setup Module
  When I create a new user with email for Setup Module "testuser41_static@mailinator.com"
